...
This section contains a list of additional resources for |RSMQTT|.
...
Examples are located under ``<|RTI_CONNEXT_GATEWAYS|'s main folder>/examples/mqtt``.
...
Tests are located under ``<|RTI_CONNEXT_GATEWAYS|'s main folder>/plugins/adapters/mqtt/test``
If you have provided CMake with an installation directory, they will be under
