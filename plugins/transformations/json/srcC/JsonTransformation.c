        ...
        struct DDS_TypeCode *tc)
{
     ...
     * will be used.
     * If the member is unbounded, it will use unbounded_member_serialized_size_initial
                ...
                const struct RTI_RoutingServiceProperties *properties)
{
    ...
    self->unbounded_member_serialized_size_initial =
            RTI_TSFM_JSON_UNBOUNDED_MEMBER_SERIALIZED_SIZE_INITIAL_DEFAULT;
    ...
    RTI_TSFM_lookup_property(
            ...
            RTI_TSFM_WARNING_2(
                    ...
                    "<%s>, use <%s> instead.",
                    RTI_TSFM_JSON_PROPERTY_SERIALIZED_SIZE_MIN,
                    RTI_TSFM_JSON_PROPERTY_UNBOUNDED_MEMBER_SERIALIZED_SIZE_INITIAL)
            self->unbounded_member_serialized_size_initial =
        ...
        RTI_TSFM_JsonTransformationConfigTypeSupport_create_data(void)
{
    ...
    sample->unbounded_member_serialized_size_initial = 0u;
