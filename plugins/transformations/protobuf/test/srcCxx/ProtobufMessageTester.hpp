...
#ifndef ProtobufMessageTester_hpp
#define ProtobufMessageTester_hpp
...
class ProtobufMessageTester : public BaseTester {
public:
    ProtobufMessageTester(const int32_t tester_id)
    : BaseTester(tester_id)
    {}

    virtual ~ProtobufMessageTester() = default;
...
#endif // ProtobufMessageTester_hpp
