...
void run_publisher_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    std::unique_ptr<MyTypeWithArrays> data(new MyTypeWithArrays());
    for (unsigned int samples_written = 0;
        ...
        std::array<NewStruct1, 5> member1;
        member1[0] = structValue1;
        member1[1] = structValue1;
        member1[2] = structValue1;
        
        data->member1(member1);

        // create member2 of the data to sent
        
        std::array<NewEnum1, 5> member2;
        
        member2[0] = NewEnum1::ENUM_VALUE_1;
        member2[1] = NewEnum1::ENUM_VALUE_1;
        member2[2] = NewEnum1::ENUM_VALUE_1;
        member2[3] = NewEnum1::ENUM_VALUE_1;
        member2[4] = NewEnum1::ENUM_VALUE_1;
        
        data->member2(member2);
        

        // create auxiliary union value
        auto unionValue1 = NewUnion1Array();
        switch(samples_written % 3) {
        ...
        std::array<NewUnion1Array, 5> member3;
        member3[0] = unionValue1;
        member3[1] = unionValue1;
        member3[2] = unionValue1;
        
        data->member3(member3);

        // create member4 of the data to sent
        std::vector<NewStruct1> member4;
        member4.push_back(structValue1);
        member4.push_back(structValue1);
