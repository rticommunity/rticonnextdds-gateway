# Mqtt Shapes - A more advanced example integration of DDS and MQTT
...
1. Enter directory `${INSTALL_DIR}/examples/mqtt/mqtt-shapes-advanced`.

    ```sh
    cd ${INSTALL_DIR}/examples/mqtt/mqtt-shapes-advanced
    ```
...
`${INSTALL_DIR}/examples/mqtt/mqtt-shapes-advanced`:
