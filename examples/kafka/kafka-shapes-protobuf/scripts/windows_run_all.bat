...
(
    ...
    START bin\shapes_mqtt_publisher localhost:1883 square-pub GREEN shapes/square 1
    START bin\shapes_mqtt_subscriber localhost:1883 square-sub shapes/square 1
    START rtishapesdemo -compact -dataType Shape -pubInterval 1000
    START rtiroutingservice -cfgFile etc/shapesdemo_mqtt_protobuf.xml -cfgName shapesdemo_bridge
) | pause
