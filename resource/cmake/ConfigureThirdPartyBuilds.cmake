...
macro (m_copy_dll_from_third_party_bin_to_lib _LIBNAME)
    install(
...
macro (m_install_dependencies_dll)
    if(WIN32)
        ...
        if(RTIGATEWAY_ENABLE_MQTT)
            if (${RTIGATEWAY_ENABLE_SSL})
                m_copy_dll_from_third_party_bin_to_lib("paho-mqtt3as")
                m_copy_dll_from_third_party_bin_to_lib("paho-mqtt3cs")
            else()
                m_copy_dll_from_third_party_bin_to_lib("paho-mqtt3a")
                m_copy_dll_from_third_party_bin_to_lib("paho-mqtt3c")
            endif()
        endif()
    endif()
endmacro()
